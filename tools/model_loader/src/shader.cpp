...
void shader::set_uniform_1i(const std::string_view uniform, GLint value) const {
    GLint location = glGetUniformLocation(_M_program, uniform.data());
    glUniform1i(location, value);
}

void shader::set_uniform_1f(const std::string_view uniform, GLfloat value) const {
    GLint location = glGetUniformLocation(_M_program, uniform.data());
